  ...
  (
    ...
    return (
      <div>
        ...
        {/* Error Text */}
        <div className="mt-1 text-xs text-gray-400">{errorMessage}</div>
      </div>
    );
  },
);
  ...
  return (
    <button
      className={twMerge(
        ...
        // color
        'border border-gray-400 shadow hover:bg-gray-100 hover:text-gray-500 dark:border-gray-600 dark: dark:hover:bg-gray-700',
        // size
